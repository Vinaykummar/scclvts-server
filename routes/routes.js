...
router.get("/vehicle/route/rfid/verify/:vehicle_no/:rfid_ip", controller.getVehicleRouteRfidPoint);
router.get("/rfids", controller.getRfids);
router.post("/createrfid/:ipadd/:name/:frontip/:topip/:mine/:area", controller.createRfid);
